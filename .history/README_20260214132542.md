...
- generators in `kitchensink_testing::generators::*`
- invariant helpers in `kitchensink_testing::law::*`
- optional mutation runtime via `cargo-pbt` (`mutation` feature)
- deterministic serialization assertions

## Minimal integration

Add test surface files in your consumer crate and import `kitchensink_testing::prelude::*`.

```toml
[dev-dependencies]
kitchensink-testing = { package = "kitchensink-testing", path = "../kitchensink-testing", default-features = false, features = ["core", "serialization", "mutation"] }
```
